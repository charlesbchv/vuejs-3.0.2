const app = Vue.createApp({
    ...
    data() {
        return { //return object
            ...
            showBooks: true,
            books: [
                {title: 'name of the wind', author: 'patrick rothfuss', age: '40', img: 'assets/1.jpg'},
                {title: 'i am legend', author: 'Francis Lawrence', age: '45', img: 'assets/2.jpg'},
                {title: 'seigneur des anneaux', author: 'Peter Jackson', age: '32', img: 'assets/3.jpg'},
                {title: 'At The Center of The Storm', author: 'George Tenet', age: '30', img: 'assets/4.jpg'},
            ]
        }
    },
